...
void dec_test() {
  ...
  assert(!strcmp("", dec_regularize_iso("")));
  assert(!strcmp(".0", dec_regularize_iso(",0")));
  assert(!strcmp("0.", dec_regularize_iso("0,")));
  assert(!strcmp("-0.", dec_regularize_iso("-0,")));
  assert(!strcmp("-.0", dec_regularize_iso("-,0")));
  assert(!strcmp("12.", dec_regularize_iso("12,")));
  assert(!strcmp(".12", dec_regularize_iso(",12")));
  assert(!strcmp("34.12", dec_regularize_iso("34,12")));
  assert(!strcmp("123341.23", dec_regularize_iso("123.341,23")));
  assert(!strcmp("-34.12", dec_regularize_iso("-34,12")));
  assert(!strcmp("-123341.23", dec_regularize_iso("-123.341,23")));
  assert(!strcmp("34", dec_regularize_iso("34")));
  assert(!strcmp("123341", dec_regularize_iso("123.341")));
  assert(!strcmp("-34", dec_regularize_iso("-34")));
  assert(!strcmp("-123341", dec_regularize_iso("-123.341")));

  assert(!strcmp("", dec_regularize_us("")));
  assert(!strcmp(".0", dec_regularize_us(".0")));
  assert(!strcmp("0.", dec_regularize_us("0.")));
  assert(!strcmp("-0.", dec_regularize_us("-0.")));
  assert(!strcmp("-.0", dec_regularize_us("-.0")));
  assert(!strcmp("12.", dec_regularize_us("12.")));
  assert(!strcmp(".12", dec_regularize_us(".12")));
  assert(!strcmp("34.12", dec_regularize_us("34.12")));
  assert(!strcmp("123341.23", dec_regularize_us("123,341.23")));
  assert(!strcmp("-34.12", dec_regularize_us("-34.12")));
  assert(!strcmp("-123341.23", dec_regularize_us("-123,341.23")));
  assert(!strcmp("34", dec_regularize_us("34")));
  assert(!strcmp("123341", dec_regularize_us("123,341")));
  assert(!strcmp("-34", dec_regularize_us("-34")));
  assert(!strcmp("-123341", dec_regularize_us("-123,341")));
